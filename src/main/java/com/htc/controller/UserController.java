...
import com.htc.services.MyUserService;
...
//	 }
	 ...
	 @PostMapping("/adduser")
		public ResponseEntity<String> AddUser(@RequestBody MyUsers user) {
		
		 if(userservice.save(user))
			 return new ResponseEntity<String>("User Added Successfully", HttpStatus.ACCEPTED);
		 
		 return new ResponseEntity<String>("Fatal error. User could not be added. Try again !!!", HttpStatus.BAD_REQUEST);
		}
